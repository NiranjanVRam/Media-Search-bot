...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=f"<b>Here is What I Found In My Database For Your Query {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  \n\nIf File Not Found, Report At @fhhelperbot </b>\n\n<i>Powered By @fileshomeofficial</i>", reply_markup=InlineKeyboardMarkup(buttons))

            else:
                await message.reply_video(video="https://telegra.ph/file/d59980009d3f4d8b89ee1.mp4", caption=f"<b>Here is What I Found In My Database For Your Query {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  \n\nIf File Not Found, Report At @fhhelperbot </b>\n\n<i>Powered By @fileshomeofficial</i>", reply_markup=InlineKeyboardMarkup(buttons))
            return
    ...
    if 2 < len(message.text) < 50:    
        ...
        if files:
            for file in files:
                ...
                filename = f"[{get_size(file.file_size)}] {file.file_name}"
                btn.append(
                    [InlineKeyboardButton(text=f"{filename}", url=f"https://telegram.dog/{nyva}?start=LiqWid_-_-_-_{file_id}")]
                )
        else:
            return
        if not btn:
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            try:
                ...
                await query.answer("You Can Use Me Only In My Group. Join Here: @fhmoviechat",show_alert=True)
                return
            ...
            await query.message.edit(text="<b>Developer : <a href='https://t.me/liqwid_x'>LiqWid</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://t.me/AdhavaaBiriyaniKittiyalo'>Click here</a>\nUpdate Channel : <a href='https://t.me/fileshomeofficial'>FH GROUP</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)



        elif query.data.startswith("LiqWid"):
